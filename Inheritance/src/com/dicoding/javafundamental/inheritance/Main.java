...
public class Main {
    public static void main(String[] args) {
        ...
        Kucing anggora2 = new Kucing();

        Hewan hewan2 = anggora2; //secara implisit upcasting
        hewan2 = (Hewan) anggora2; //secara explisit melakukan casting dari subclass ke superclass

        Hewan hewan3 = new Kucing();
        ((Kucing) hewan3).meow(); //downcast hewan ke kucing, casting dari superclass ke subclass
    }
}
